...
lapply(c("tidyverse","ggthemes","multcomp","emmeans","Hmisc","car","here"),require,character.only=T) #load packages
...
## SLIDE 5
# Read in the data and order the rows by the StartDate column
m=read.csv(here("data/Lectures/MoltDataForMarm.csv"))
...
#relevel the factos so that Juvenile Male is the "reference" level
